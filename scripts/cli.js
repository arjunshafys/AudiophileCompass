...
const contractABI = require("../artifacts/contracts/Audiophilecompass.sol/Audiophilecompass.json").abi;

program
    .name("audiophilecompass-cli")
    .description("CLI tool for Audiophilecompass smart contract")
    .version("1.0.0");
